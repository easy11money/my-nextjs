            ...
            <div className="bg-gray-200 pb-20">
                <div className="grid max-w-6xl grid-cols-2 gap-4 px-6 py-6 mx-auto md:grid-cols-3 lg:grid-cols-4">
                    ...
                    <div className="col-span-2 row-span-1 border-4 hover:border-orange-300 rounded-3xl bg-white">
                        <div className="p-6">
                            <img className="mx-auto max-h-28" src="/image/3.png" alt="logo" width="200px" height="150px" />
                            <p className="mt-4 text-1xlg text-center">Hello 👋 ! I m<strong className="font-bold text-orange-300 text-3xl">Thomas</strong>, a freelance developer and indie maker from France. I work with Vue, Tailwind, Figma, and a laptop. Oh and I'm very funny.</p>
                        </div>
                    </div>
                    <div className="flex flex-col  text-center space-y-6 cursor-pointer">
                        <div className="flex gap-5">
                    ...
                    <div className="hover:shadow-lg col-span-2 row-span-1 border-4 hover:border-orange-300 rounded-3xl bg-white">
                        <div className="p-6">
                            <div>
                                ...
                                <p className="text-lg">I've also worked on <strong className="text-orange-300">form validation, two factors authentication, permissions systems, custom component libraries,</strong> and lots of other fun stuff!</p>
